<script lang="ts">
// Copied from https://github.com/valgeirb/vue-confetti-explosion

import { computed, onMounted, watchEffect, ref, type PropType } from "vue";
...
const FLOOR_HEIGHT = 1500; // pixels the particles will fall from initial explosion point
const FLOOR_WIDTH = 1500; // horizontal spread of particles in pixels
