...
<template>
  <div class="menu-frame-wrapper">
    ...
    <div class="frame-inner">
      <h2>Are we listening to your conversations?</h2>
      <div class="item-wrapper">
        <menu-item class="item"
                   id="listening-to-conversations-ad-preferences"
                   item-name="Ad preferences"
                   @click="$router.push('AdPreferences')"
        ></menu-item>
        <menu-item class="item"
                   id="listening-to-conversations-access-info"
